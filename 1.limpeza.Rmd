...
dados[dados$Idade<18 | dados$Idade>110 ,]$Idade
#não temos idade NAs
dados[is.na(dados$Idade),]
#opção, preencher com mediana
median(dados$Idade)
#subtituição
dados[dados$Idade<18 | dados$Idade>110 ,]$Idade = median(dados$Idade) 
#buscamos novamente idades anormais
dados[dados$Idade<18 | dados$Idade>110 ,]
summary(dados$Idade)
```
Dados duplicados
```{r}
...
#O Estado de SP é um valor errônico.
#Os Estados de TD e RP não existem.
